                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td>: <span class="fw-semibold">{{ \Carbon\Carbon::parse($data->tanggal_pinjam)->format('d/m/Y') }}</span></td>
                                    </tr>
                                    <tr>
                                        <th class="text-muted">
                                        ...
                                        <td>:
                                            @if($data->tanggal_pengembalian)
                                                <span class="fw-semibold">{{ \Carbon\Carbon::parse($data->tanggal_pengembalian)->format('d/m/Y') }}</span>
                                            @else
