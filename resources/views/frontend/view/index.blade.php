                    ...
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 order-lg-1 order-2">
                            <div class="carousel-text">
                                ...
                                <p class="mb-4 text-secondary">
                                    {{ Str::limit($row->deskripsi ?? 'Nikmati pengalaman membaca yang menyenangkan dengan koleksi buku terbaik kami.', 120) }}
                                </p>
                                <div class="d-flex flex-wrap gap-3">
                                    <a class="btn btn-primary py-3 px-5 rounded-pill shadow-sm"
                                        href="{{ route('pinjam.form', $row->id_buku) }}">
                                        <i class="fas fa-book-open me-2"></i>Pinjam Sekarang
                                    </a>
                                    <a class="btn btn-outline-secondary py-3 px-5 rounded-pill"
                                        href="{{ route('detail', $row->id_buku) }}">
                        ...
                        <div class="col-lg-6 order-lg-2 order-1 d-flex justify-content-center align-items-center">
                            <div class="carousel-img">
                                <img class="img-fluid rounded-4 shadow-lg" src="{{ asset('/storage/buku/' . $row->gambar) }}"
                                    alt="{{ $row->judul }}"
                    ...
                    <div class="card h-100 border-0 shadow-sm rounded-4 hover-card">
                        <div class="position-relative overflow-hidden rounded-top-4">
                            <a href="{{ route('detail', $item->id_buku) }}">
                                <img src="{{ asset('/storage/buku/' . $item->gambar) }}" class="card-img-top p-3"
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="mb-1 small text-muted">
                                    <i
                                        class="fas fa-building me-2 text-primary"></i>{{ $item->penerbit ?? 'Tidak diketahui' }}
                                </p>
                                <p class="mb-1 small text-muted">
                                    <i
                                        class="fas fa-calendar me-2 text-primary"></i>{{ \Carbon\Carbon::parse($item->tahun_terbit)->format('Y') }}
                                </p>
                            ...
                            <div class="mt-auto">
                                <button class="btn btn-sm btn-primary w-100 rounded-pill"
                                    onclick="pinjamBuku({{ $item->id_buku }})" {{ $item->stok < 1 ? 'disabled' : '' }}>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="bg-primary bg-gradient text-white rounded-4 p-5 text-center shadow-lg">
                        ...
                        <p class="mb-4 opacity-75">Dapatkan akses ke ribuan koleksi buku dan nikmati kemudahan peminjaman
                            online</p>
                        <div class="d-flex justify-content-center gap-3 flex-wrap">
                            <a href="{{ route('register_anggota') }}"
                                class="btn btn-light text-primary px-4 py-2 rounded-pill fw-bold">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="bg-success bg-gradient text-white rounded-4 p-5 text-center shadow-lg">
                        ...
                        <h2 class="fw-bold mb-3">Selamat Datang Kembali,
                            {{ auth()->guard('anggota')->user()->nama ?? (auth()->guard('anggota')->user()->name ?? 'Anggota') }}!
                            👋</h2>
                        <p class="mb-4 opacity-75">Nikmati kemudahan meminjam buku secara online. Temukan buku favorit Anda
                            sekarang!</p>
                        <div class="d-flex justify-content-center gap-3 flex-wrap">
                            <a href="{{ route('semua.buku') }}"
                                class="btn btn-light text-success px-4 py-2 rounded-pill fw-bold">
